...
var editUnit = function() {
    ...
    html += '<div class="form-group"><label class="col-sm-3 control-label">企业机构代码<span class="rt-glyphicon-color">:</span></label><div class="col-sm-6"><input readonly name="Identification_Number" type="text" class="form-control rt-form-control" placeholder="企业机构代码" value="' + identification_number + '"></div></div>';
...
var editPersonnel = function() {
    ...
    var home = $(this).parent().siblings('[name=home]').data('value');
    ...
    html += '<div class="form-group"><label class="col-sm-3 control-label">手机号<span class="rt-glyphicon-color">:</span></label><div class="col-sm-6"><input readonly name="Phone" type="text" class="form-control rt-form-control" placeholder="手机号" value="' + phone + '"></div></div>';
    html += '<div class="form-group"><label class="col-sm-3 control-label">职业<span class="rt-glyphicon-color">:</span></label><div class="col-sm-6"><input readonly name="Occupation" type="text" class="form-control rt-form-control" placeholder="职业" value="' + occupation + '"></div></div>';
    html += '<div class="form-group"><label class="col-sm-3 control-label">常住地<span class="rt-glyphicon-color">:</span></label><div class="col-sm-6"><input readonly name="Home" type="text" class="form-control rt-form-control" placeholder="常住地" value="' + home + '"></div></div>';
